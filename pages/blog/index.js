...
const Blog = ({posts}) => {
    ...
    const handleBlog = async (slug, method) => {
            ...
            <>
                        ...
                        <div
                            ...
                            {posts && posts.map((post) => (
                                <div key={post.slug} onClick={() => Router.push(`/blog/${post.slug}`)}>
                                    <img className="w-full h-60 rounded-lg shadow-lg object-cover" src={post.image}
                                         alt={post.title}/>
                ...
                {process.env.NODE_ENV === 'development' && mounted && (
                    <div className="fixed bottom-6 right-6">
                        <Button onClick={() => handleBlog(null, "POST")} type={"primary"}>
                            Add New Post +
                        </Button>
                    </div>
                )}
